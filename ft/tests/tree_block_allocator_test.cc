...
static void test_ba0(tree_block_allocator::allocation_strategy strategy) {
    tree_block_allocator allocator;
    tree_block_allocator *ba = &allocator;
...
static void
test_ba1(tree_block_allocator::allocation_strategy strategy, int n_initial) {
    tree_block_allocator allocator;
    tree_block_allocator *ba = &allocator;
...
test_ba2 (void)
{
    ...
    ba->set_strategy(tree_block_allocator::BA_STRATEGY_FIRST_FIT);
    assert(ba->allocated_limit()==100*512);
...
test_main (int argc __attribute__((__unused__)), const char *argv[] __attribute__((__unused__))) {
    enum tree_block_allocator::allocation_strategy strategies[] = {
        tree_block_allocator::BA_STRATEGY_FIRST_FIT,
    };
