...
void toku_os_full_pwrite (int fd, const void *buf, size_t len, toku_off_t off, const char * dbg_context) __attribute__((__visibility__("default")));
void toku_os_full_write (int fd, const void *buf, size_t len, const char * dbg_context) __attribute__((__visibility__("default")));
