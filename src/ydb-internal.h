...
typedef enum __toku_isolation_level { 
    ...
    TOKU_ISO_REAL_READ_COMMITTED=5
} TOKU_ISOLATION;

// needed in ydb_db.c
#define DB_ISOLATION_FLAGS (DB_READ_COMMITTED | DB_READ_COMMITTED_ALWAYS |DB_REAL_READ_COMMITTED| DB_READ_UNCOMMITTED | DB_TXN_SNAPSHOT | DB_SERIALIZABLE | DB_INHERIT_ISOLATION)
